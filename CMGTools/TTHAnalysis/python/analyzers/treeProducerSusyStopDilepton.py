...
susyStopDilepton_globalVariables = susyCore_globalVariables + [
...
susyStopDilepton_globalObjects = susyCore_globalObjects.copy()
susyStopDilepton_globalObjects.update({
            # put more here
})

susyStopDilepton_collections = susyCore_collections.copy()
susyStopDilepton_collections.update({
